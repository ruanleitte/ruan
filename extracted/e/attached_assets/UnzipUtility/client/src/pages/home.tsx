          ...
          >
            ...
            <div>
              <h1 className="text-3xl md:text-4xl mb-3 font-bold uppercase">
                <span className="inline-block">{language === 'pt-br' ? 'EU SOU' : language === 'es' ? 'YO SOY' : 'I\'M'}</span> <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary inline-block whitespace-nowrap text-3xl md:text-4xl">RUAN JASIEL</span>
              </h1>
              
              <h2 className="text-xl md:text-2xl uppercase font-medium flex items-baseline">
                <span className="mr-2">{language === 'pt-br' ? 'EU FAÇO' : language === 'es' ? 'YO HAGO' : 'I DO'}</span>
