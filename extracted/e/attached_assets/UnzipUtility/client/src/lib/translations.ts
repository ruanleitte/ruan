...
export const translations: TranslationsType = {
  'pt-br': {
    ...
    portfolio: {
      title: 'MEU PORTFÓLIO',
      subtitle: 'Conheça as empresas em que trabalhei. Este portfólio foca nos setores de atuação e mercados de cada organização.',
      allCategories: 'Todas',
      logistics: 'Logística',
      education: 'Educação',
      services: 'Serviços',
  ...
  'en': {
    ...
    portfolio: {
      title: 'MY PORTFOLIO',
      subtitle: 'Learn about the companies I have worked with. This portfolio focuses on the business sectors and markets of each organization.',
      allCategories: 'All',
      logistics: 'Logistics',
      education: 'Education',
      services: 'Services',
  ...
  'es': {
    ...
    portfolio: {
      title: 'MI PORTAFOLIO',
      subtitle: 'Conoce las empresas con las que he trabajado. Este portafolio se centra en los sectores de negocio y mercados de cada organización.',
      allCategories: 'Todas',
      logistics: 'Logística',
      education: 'Educación',
      services: 'Servicios',
